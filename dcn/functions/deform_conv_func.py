...
def load_d3d_extension():
    ...
    source_cpu = [os.path.join(extensions_dir, "cpu", "deform_cpu.cpp")]  # Add any CPU-specific source files
    source_cuda = [os.path.join(extensions_dir, "cuda", "deform_conv_cuda.cu")]
